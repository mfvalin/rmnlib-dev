...
typedef struct {
  unsigned int 
     ...
     old:1,    scratch:1, notpaged:1, pipe:1, write_mode:1, remote:1,     wap:1,    stdp:1,
     sparse:1, atomic:1,  padding1:6,
     padding2:8  ;
} attributs;

// MAJOR DIFFERENCE with previous version : file_size and eff_file_size are now 64 bit values (large files)
typedef struct {
